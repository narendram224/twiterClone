  ...
  return (
    <aside className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full ">
      ...
      <div className="space-y-2.5 mt-4 mb-2.5 xl:ml-24">
        ...
        <SidebarLink text="Book" Icon={BookmarkIcon} />
      ...
      <button
        type="button"
        className=" hidden xl:inline ml-auto bg-[#1d9bf0] text-white rounded-full w-56 text-lg font-bold shadow-md h-[52px] hover: bg-[#1a8cd8] "
      >
        Tweet
      </button>
      <div className="text-[#d9d9d9] flex items-center justify-center hoverAnimation xl:ml-auto xl:-mr-5 mt-auto ">
        ...
        <div className="hidden xl:inline leading-5">
          <h4 className="font-bold">firebase 15</h4>
          <p className="text-[#6e767d]">@firabse1875</p>
        </div>
